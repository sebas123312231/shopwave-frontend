...
const variantMap: Record<NonNullable<ButtonProps['variant']>, string> = {
  primary: 'bg-accent text-white hover:bg-accent-dark hover:shadow-lg hover:shadow-purple-500/25 hover:scale-[1.02] active:scale-[0.98]',
  secondary: 'bg-surface text-foreground border border-border hover:border-accent hover:bg-accent/5 active:bg-accent/10',
