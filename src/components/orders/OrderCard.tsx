    ...
    <div className="bg-surface border border-border rounded-2xl p-5 md:p-6 shadow-sm hover:shadow-md transition-shadow duration-200 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 animate-slideUp">
      ...
      <div className="flex flex-col items-end gap-3 w-full md:w-auto">
        ...
        <Link
          ...
          className="inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-white bg-accent rounded-xl hover:bg-accent-dark transition-all hover:shadow-lg hover:shadow-purple-500/25 w-full md:w-auto text-center"
        >
          Ver Detalles
          <ArrowRight size={14} />
        </Link>
